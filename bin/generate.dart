...
const constAnnotation = 'isolatesHelperWorker';
...
Future<void> generate(List<String> args) async {
  final parser = ArgParser()
    ...
    ..addOption(
      ...
      valueHelp: 'worker',
      defaultsTo: 'worker',
      help: 'Name of the generated JS. Default is set to `worker`.',
    )
    ..addFlag(
      'debug',
      defaultsTo: false,
...
Future<void> _generateFromAnotatedFunctions(
  ...
  final file = File('.IsolatesHelperWorker.${anotatedFunctions.hashCode}.dart');
  final sink = file.openWrite();
  sink.writeln("import 'package:isolates_helper/isolates_helper.dart';");
  ...
  sink.writeln('};');
  sink.writeln('main() {');
  sink.writeln('  IsolatesHelper.workerFunction(map);');
  sink.writeln('}');
  await sink.close();

...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    add(values) {
      ...
      t1 = J.$add$ansx(t1.$index(values, 0), t1.$index(values, 1));
      return t1;
    }
  },
  J = {
  ...
  A.ListBase.prototype = {
    ...
    $add(receiver, other) {
      ...
      t1 = A.List_List$of(receiver, t1._eval$1("ListBase.E"));
  ...
  A.main_closure0.prototype = {
    ...
    $call$body$main_closure(message) {
      var $async$goto = 0,
        ...
        $function, params, err, stack, t1, function0, exception, completer;
          ...
          switch ($async$goto) {
            case 0:
              ...
              try {
                ...
                function0 = $.map.$index(0, t1.$index(message, 0));
                $function = function0 == null ? type$.Function._as(function0) : function0;
                params = t1.$index(message, 1);
                J.complete$1$z(completer, $function.call$1(params));
              } catch (exception) {
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "functions__add$closure", "add", 26);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(String,@)", "@(@)", "~(~())", "Null(@)", "Null()", "~(@)", "~(Object,StackTrace)", "~(Object?,Object?)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Symbol0,@)", "~(String,String)", "JsFunction(@)", "JsArray<@>(@)", "JsObject(@)", "@(MessageEvent)", "Future<~>(@)", "~(@,@)", "Object?(Object?)", "Object?(@)", "Object(@)"],
...
;
  ...
  (function staticFields() {
    ...
    $.map = A.LinkedHashMap_LinkedHashMap$_literal(["add", A.functions__add$closure()], type$.String, type$.Function);
  })();
